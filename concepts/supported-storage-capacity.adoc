...
在订阅期间，您可以根据某些条件更改承诺的容量。有关容量增加和减少规则的完整详细信息，请参阅 link:../concepts/capacity-requirements.html["Keystone性能服务级别的容量要求"]。要请求更改，请联系您的 Keystone Success Manager (KSM) 或参阅 link:../concepts/support-services.html["NetApp Keystone支持"]。
