...
| <=1毫秒 | <=1毫秒 | <=4毫秒 | >=4毫秒 
|===
要了解有关性能服务级别的延迟要求的详细信息，请参阅 link:../concepts/service-levels.html["Keystone 中的性能服务级别"]。
...
* 服务积分可能会应用于未来的发票。服务积分不适用于过期的 Keystone 订阅。要了解更多信息，请参阅link:../concepts/support-services.html["NetApp Keystone支持"]。
