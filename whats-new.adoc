...
要了解更多信息，请参阅 https://docs.netapp.com/us-en/keystone-staas/integrations/monitoring-alert-monitors.html["查看并创建Keystone订阅的警报监视器"]。
...
现在，您可以使用 *消费趋势* 选项卡的 *累计突发* 视图中的 *预测* 切换来预测当前日期后 120 天的累计突发使用情况。要了解更多信息，请参阅 https://docs.netapp.com/us-en/keystone-staas/integrations/consumption-tab.html#view-forecast-data["查看预测数据"]。
...
*消费趋势*选项卡中的历史消费图表现在突出显示超出突发限制的使用情况。要了解更多信息，请参阅 https://docs.netapp.com/us-en/keystone-staas/integrations/consumption-tab.html["查看 Keystone 订阅的消费趋势"]。
...
您可以在 *消耗趋势* 选项卡的 *历史消耗* 视图中使用 *Forecast* 切换来预测当前日期后 120 天的容量使用情况。要了解更多信息，请参阅 https://docs.netapp.com/us-en/keystone-staas/integrations/consumption-tab.html#view-forecast-data["查看预测数据"]。
...
Data Infrastructure Insights (DII) 附加组件消耗现在显示在*当前消耗*和*消耗趋势*选项卡中。要了解更多信息，请参阅 https://docs.netapp.com/us-en/keystone-staas/concepts/data-infra-insights.html#view-dii-consumption["查看 DII 消耗量"]。
...
您可以联系 Keystone 支持团队订阅 Keystone 版本 3 (v3)。有关更多详细信息，请参阅 link:https://docs.netapp.com/us-en/keystone-staas/concepts/support-services.html["Keystone 的支持服务"]。
